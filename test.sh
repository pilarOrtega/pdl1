...
python test.py -s '/home/DeepLearning/media/pdl1/RC.PDL1.V2' -o '/data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207' -l 16 -tr 0.25 -ts 224 -f 'DenseH' -n 1 -m 'BottomUp' --flag 2 -j -2 | tee /data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207/Records/DenseH_complete.txt

python test.py -s '/home/DeepLearning/media/pdl1/RC.PDL1.V2' -o '/data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207' -l 16 -tr 0.25 -ts 224 -f 'Dense' -n 1 -m 'BottomUp' --flag 2 -j -2 | tee /data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207/Records/Dense_complete.txt

python test.py -s '/home/DeepLearning/media/pdl1/RC.PDL1.V2' -o '/data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207' -l 16 -tr 0.25 -ts 224 -f 'DaisyDAB' -n 1 -m 'BottomUp' --flag 2 -j -2 | tee /data/DeepLearning/ABREU_Arnaud/Pilar_stage/tests/Results_0207/Records/DaisyDAB_complete.txt
